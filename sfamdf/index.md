...
- **Graduated response**: Escalate from observation to isolation to active defense
...
- [Architecture Diagrams](../architecture/) - Visual reference
- [Reactive vs Proactive](../comparison/) - Detailed comparison
- [OSINT Agent Pattern](../patterns/osint/) - Implementation example
